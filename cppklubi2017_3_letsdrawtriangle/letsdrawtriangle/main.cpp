...
int main(int argc, char* argv[])
{
	...
	static const float vertices[] = {
		0.0f, 0.f, 0.0f, 0.2f, 0.3f, 0.4f, 1.0f,		//yl‰ vasen
		100.0f, 0.f, 0.0f, 0.1f, 0.5f, 0.1f, 1.0f,		//yl‰ oikea
		0.0f, 100.0f, 0.0f, 0.4f, 0.7f, 0.9f, 1.0f,		//ala vasen

		//0.0f, 100.f, 0.0f, 0.2f, 0.3f, 0.4f, 1.0f,		//ala vasen
		//100.0f, 0.f, 0.0f, 0.1f, 0.5f, 0.1f, 1.0f,		//yl‰ oikea
		100.0f, 100.0f, 0.0f, 0.4f, 0.7f, 0.9f, 1.0f,	//ala oikea

		200.0f, 0.f, 0.0f, 0.2f, 0.3f, 0.4f, 1.0f,		//yl‰ vasen
		300.0f, 0.f, 0.0f, 0.1f, 0.5f, 0.1f, 1.0f,		//yl‰ oikea
		200.0f, 100.0f, 0.0f, 0.4f, 0.7f, 0.9f, 1.0f,		//ala vasen
		300.0f, 100.0f, 0.0f, 0.4f, 0.7f, 0.9f, 1.0f	//ala oikea
	...
	while (running)
	{
		...
		GLint mvpLocation = glGetUniformLocation(program, "u_mvp");
		glUniformMatrix4fv(mvpLocation, 1, GL_FALSE, glm::value_ptr(projection));

		GL_CHECK(glBindVertexArray(VAO));
		GL_CHECK(glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, IBO));

		GL_CHECK(glDrawElements(GL_TRIANGLES, 12, GL_UNSIGNED_SHORT, nullptr));
